...
export default function SkillContainer(props: SkillContainerProps) {
  ...
  return (
    <div className="flex flex-col md:w-[48%] gap-6">
      ...
      <div className="flex flex-wrap w-full gap-5">
        {skills.map((skill, index) => (
          <li
            className="flex flex-grow p-4 rounded bg-gray-800 basis-2/5 gap-3 lg:gap-6 justify-start items-center bg-gray"
            key={index}
          >
            <img
              className="h-5 w-5 md:h-8 md:w-8 object-cover object-center "
              src={skill.image}
              alt="content"
              sizes="8px"
              loading="lazy"
