      ...
      <div className="container mx-auto flex flex-col items-center px-10 py-20">
        <div className="flex flex-col items-center flex-grow ">
          ...
          <div className="flex justify-center">
            ...
            <a
              href="#projects"
              className="text-base ml-6 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg"
            >
              See My Works
            </a>
          </div>
